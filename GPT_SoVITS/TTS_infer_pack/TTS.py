...
class TTS_Config:
    default_configs={
        "default":{
                ...
                "is_half": False,
                "version": "v1",
                "t2s_weights_path": "models/Hutao_GPT.ckpt", # 변경한 부분 (v1은 건들필요 없지만 혹시몰라 변경함)
                "vits_weights_path": "models/Hutao_Sovits.pth", # 변경한 부분
                "cnhuhbert_base_path": "GPT_SoVITS/pretrained_models/chinese-hubert-base",
                "bert_base_path": "GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",
            },
        "default_v2":{
                ...
                "is_half": False,
                "version": "v2",
                "t2s_weights_path": "models/Hutao_GPT.ckpt", # 변경한 부분
                "vits_weights_path": "models/Hutao_Sovits.pth", # 변경한 부분
                "cnhuhbert_base_path": "GPT_SoVITS/pretrained_models/chinese-hubert-base",
                "bert_base_path": "GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",
            },
